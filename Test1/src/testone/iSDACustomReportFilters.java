	...
	public static void main(String args[]) throws InterruptedException, AWTException{
	 CreatISDACustomReportFilter();{
	     ...
	     SimpleDateFormat ft =  new SimpleDateFormat ("E yyyy.MM.dd 'at' hh:mm:ss a zzz");
				...
				driver.findElement(By.xpath(".//*[@id='tbReportName']")).sendKeys("v1"+ ft.format(dNow));
				...
				Thread.sleep(10000);
				Robot rbt=new Robot();
				rbt.keyPress(java.awt.event.KeyEvent.VK_DOWN);
				Thread.sleep(5000);
...
//				driver.close();
				...
				driver.findElement(By.xpath(".//*[@id='tbReportName']")).sendKeys("value"+ ft.format(dNow));
				driver.findElement(By.xpath(".//*[@id='Submit']")).click();
				Thread.sleep(20000);
				...
				rbt5.keyPress(java.awt.event.KeyEvent.VK_DOWN);
				Thread.sleep(5000);
				Robot rbt6=new Robot();
				rbt6.keyPress(java.awt.event.KeyEvent.VK_ENTER);
				Thread.sleep(5000);
				
				driver.findElement(By.xpath(".//*[@id='download41PDF1']")).click();
				Thread.sleep(5000);
				Robot rbt7=new Robot();
				rbt7.keyPress(java.awt.event.KeyEvent.VK_ENTER);
				Thread.sleep(5000);
				
				driver.findElement(By.xpath(".//*[@id='download113PDF1']")).click();
				Thread.sleep(5000);
				Robot rbt8=new Robot();
				rbt8.keyPress(java.awt.event.KeyEvent.VK_ENTER);
				Thread.sleep(5000);
				
				driver.findElement(By.xpath(".//*[@id='download1113PDF1']")).click();
				Thread.sleep(5000);
				Robot rbt9=new Robot();
				rbt9.keyPress(java.awt.event.KeyEvent.VK_ENTER);
				Thread.sleep(4000);
				driver.close();
			...
			private static void CreatISDACustomReportFilter() {
		// TODO Auto-generated method stub
		
	}

			public static void CreatISDACustomReportFilters(String value, String v1) throws InterruptedException, AWTException {
				// TODO Auto-generated method stub
				...
				driver.findElement(By.xpath(".//*[@id='tbReportName']")).sendKeys(v1);
				driver.findElement(By.xpath(".//*[@id='Submit']")).click();
				Thread.sleep(20000);
...
//				driver.close();
				...
				driver.findElement(By.xpath(".//*[@id='tbReportName']")).sendKeys("bcvbnvb");
				driver.findElement(By.xpath(".//*[@id='Submit']")).click();
				Thread.sleep(20000);
